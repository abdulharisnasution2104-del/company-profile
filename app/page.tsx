    ...
    <main className="bg-black text-white min-h-screen">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-zinc-900 p-8 rounded-3xl">
              ...
              <p className="text-zinc-400 mt-3">
                Solusi digital untuk monitoring lahan,
                irigasi, produktivitas, dan pengelolaan
                pertanian modern.
              </p>
            </div>
            ...
            <div className="bg-zinc-900 p-8 rounded-3xl">
              ...
              <p className="text-zinc-400 mt-3">
                ...
                koperasi, distributor hasil tani,
                dan UMKM pertanian.
              </p>
            </div>
            ...
            <div className="bg-zinc-900 p-8 rounded-3xl">
              ...
              <p className="text-zinc-400 mt-3">
                Sistem pencatatan panen,
                inventory, distribusi,
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-zinc-900 p-8 rounded-3xl">
              <h3 className="text-2xl font-bold">
                Sistem Monitoring Lahan
              </h3>

              <p className="text-zinc-400 mt-4">
                Dashboard digital untuk memantau
                kondisi lahan dan produktivitas
            ...
            <div className="bg-zinc-900 p-8 rounded-3xl">
              <h3 className="text-2xl font-bold">
                Aplikasi Pencatatan Panen
              </h3>

              <p className="text-zinc-400 mt-4">
                Sistem pencatatan hasil panen,
                stok gudang, dan distribusi hasil tani.
              </p>
            </div>

            <div className="bg-zinc-900 p-8 rounded-3xl">
              <h3 className="text-2xl font-bold">
                Website Distributor Pupuk
              </h3>

              <p className="text-zinc-400 mt-4">
                Website perusahaan dengan katalog
                produk dan sistem pemesanan online.
              </p>
            </div>

            <div className="bg-zinc-900 p-8 rounded-3xl">
              <h3 className="text-2xl font-bold">
                Dashboard Agribisnis
              </h3>

              <p className="text-zinc-400 mt-4">
                Monitoring penjualan, inventory,
                dan laporan bisnis agrikultur.
              </p>
            </div>
      ...
      >
        ...
        <p className="text-zinc-400 mt-6">
          Siap membantu transformasi digital
        ...
        <a
          ...
          target="_blank"
          className="inline-block mt-8 bg-emerald-500 hover:bg-emerald-600 transition px-8 py-4 rounded-xl font-semibold"
        >
          Chat WhatsApp
        </a>
      </section>
